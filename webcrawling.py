...
'''
This script crawls the website and saves the URLs to a CSV file.
It uses BFS (Breadth-First Search) to find pages.
...
MAX_PAGES_TO_CRAWL = 20  # Limit to avoid overwhelming the site
...
save_path = os.path.join(output_dir, f"URL_List.csv")
